            ...
            <div class="container row row-cols-xl-3">
                ...
                <?php foreach($items as $item):  ?>
                    <div class="shopRow d-flex flex-column px-3 mb-5">
                        <h4 class= "sizeNom mb-2 mt-2"><a class= "sizeNom" href="View/shopArticle.php?id=<?=$item['id_produit']?>"><?= substr($item['nom_produit'],0,50)?></a></h4>
                        ...
                        <div class="shop-card">
                            <form method="POST" class="d-flex flex-row align-items-center mt-2 me-1">
                                ...
                                <button type="submit" class="btn border-1 border-dark rounded-0 px-1 ms-2 mb-3 text-nowrap" value="<?= $item['id_produit'] ?>" name="addToCart" >
                                    <p class="small" style="font-size:0.75em;">add to cart</p>
                                </button>
                            </form>
                            <?php endif; ?>
