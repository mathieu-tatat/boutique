...
<div class="d-flex flex-row align-items-center">
    <a href="index.php" class="alert-link"><div class="col-sm-1"><img src="Elements/logos/fox.svg"></a>
</div>
    ...
    <?php else: ?>
        ...
        <a href="profil.php" class="alert-link" ><img src="Elements/logos/man.svg"alt="cart" id="cartIcon"></a>
    <?php endif; ?>
</div>
