        ...
        <div class="d-flex flex-column justify-content-between align-items-center">
            <div class="d-flex container-fluid flex-row justify-content-evenly align-items-center mt-3">
                <a href="#settings-path" class="d-flex flex-column align-items-center">
                    <img src="Elements/logos/settings.svg" alt="settingsicon">
                    <div class="h-3 mt-2"><b>Compte</b></div>
                </a>
                <a href="#cart-path" class="d-flex flex-column align-items-center">
                    <img src="Elements/logos/mycart.svg" alt="secondcarticon" >
                    <div class="h-3 mt-2"><b>Panier</b></div>
                </a>
                <a href="#order-path" class="d-flex flex-column align-items-center">
                    <img src="Elements/logos/orders.svg" alt="secondcarticon" >
                    <div class="h-3 mt-2"><b>Commandes</b></div>
                </a>
            </div>
            <div class="container-xl px-4 mt-4">
                <div class=" border border-secondary border-1 px-4 mt-4 mb-2" id="settings-path">
                    <div class="display-6 px-4 mt-4"><b>Informations sur le compte</b></div>
